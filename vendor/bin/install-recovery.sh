#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/by-name/recovery$(getprop ro.boot.slot_suffix):67108864:539ea4dd69d7ead0b3f997b3375a5d9974e66850; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/by-name/boot$(getprop ro.boot.slot_suffix):67108864:8041ae6a4d4d556e9652701efc2138a20f4ea0ff \
          --target EMMC:/dev/block/by-name/recovery$(getprop ro.boot.slot_suffix):67108864:539ea4dd69d7ead0b3f997b3375a5d9974e66850 && \

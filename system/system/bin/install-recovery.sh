#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/by-name/recovery$(getprop ro.boot.slot_suffix):67108864:82f39413de3d81ba30d3579c4f9c968024295bd8; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/by-name/boot$(getprop ro.boot.slot_suffix):67108864:1c342bc3817860e254d0dd30ef7a42e6f64af3ea \
          --target EMMC:/dev/block/by-name/recovery$(getprop ro.boot.slot_suffix):67108864:82f39413de3d81ba30d3579c4f9c968024295bd8 && \
